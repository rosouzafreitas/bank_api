...
router.put('/deposit', transactions_controller_1.depositIntoAccount);
router.put('/withdraw', transactions_controller_1.withdrawFromAccount);
router.put('/transfer', transactions_controller_1.transferFromAccount);
