...
exports.transferFromAccount = exports.withdrawFromAccount = exports.depositIntoAccount = void 0;
...
const transferFromAccount = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const transaction = yield database_1.pool.query('INSERT INTO transactions (id, origin_account, destination_account, transaction_type, value) VALUES ($1, $2, $3, $4, $5)', [
            (0, uuid_1.v4)(),
            account.rows[0]['id'],
            destination.rows[0]['id'],
            'transfer',
...
exports.transferFromAccount = transferFromAccount;
